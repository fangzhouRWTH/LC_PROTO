...
class IsaacPeopleSumoDynamicAgentBackend:
    """Composite backend: Isaac People pedestrians + mock SUMO vehicles."""
    ...
    def __init__(
        ...
        self.pedestrian_backend = IsaacPeopleDynamicAgentBackend(
    ...
    def actor_count(self) -> int:
        return self.pedestrian_backend.actor_count + self.vehicle_backend.actor_count
