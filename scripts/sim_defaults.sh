...
DYNAMIC_PEDESTRIAN_ASSET_SCALE="${DYNAMIC_PEDESTRIAN_ASSET_SCALE:-}"
DYNAMIC_PEDESTRIAN_ANIMATION="${DYNAMIC_PEDESTRIAN_ANIMATION:-}"
DYNAMIC_PEDESTRIAN_ANIMATION_CLIP_PATH="${DYNAMIC_PEDESTRIAN_ANIMATION_CLIP_PATH:-}"
DYNAMIC_PEDESTRIAN_ANIMATION_TIME_SCALE="${DYNAMIC_PEDESTRIAN_ANIMATION_TIME_SCALE:-}"
DYNAMIC_VEHICLE_VISUAL="${DYNAMIC_VEHICLE_VISUAL:-}"
DYNAMIC_VEHICLE_ASSET_PATH="${DYNAMIC_VEHICLE_ASSET_PATH:-}"
DYNAMIC_VEHICLE_ASSET_SCALE="${DYNAMIC_VEHICLE_ASSET_SCALE:-}"
ENABLE_PATH_CAMERAS="${ENABLE_PATH_CAMERAS:-}"
PATH_CAMERA_SPEED_MPS="${PATH_CAMERA_SPEED_MPS:-}"
PATH_CAMERA_ROUTE_MODE="${PATH_CAMERA_ROUTE_MODE:-}"
PATH_CAMERA_INDEX="${PATH_CAMERA_INDEX:-}"
WEATHER="${WEATHER:-}"
DAYTIME="${DAYTIME:-}"
...
build_sim_args() {
  ...
  append_sim_arg_if_set "--enable-path-cameras" "${ENABLE_PATH_CAMERAS}"
  append_sim_arg_if_set "--path-camera-speed-mps" "${PATH_CAMERA_SPEED_MPS}"
  append_sim_arg_if_set "--path-camera-route-mode" "${PATH_CAMERA_ROUTE_MODE}"
  append_sim_arg_if_set "--path-camera-index" "${PATH_CAMERA_INDEX}"
